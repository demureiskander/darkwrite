...
import type { CreateWorkspaceDTO, UpdateWorkspaceDTO } from "./dto/request/workspace.request";
...
import type { Note, NoteContentResponseDTO, NoteExportFormat, NoteImportResult, NotePartial, NotesResponseDTO } from "./note";
...
export interface INoteAPI {
    ...
    export: (fileContent: string, fileType: NoteExportFormat, title?: string) => ApiResult<string | undefined>;
    /** @returns the file path of the exported PDF, or undefined if the export was cancelled. */
    exportPdf: (html: string, title?: string, pageSize?: PageSize) => ApiResult<string | undefined>;
    import: () => ApiResult<NoteImportResult>;
}
export interface IWorkspaceAPI {
    create: (dto: CreateWorkspaceDTO) => ApiResult<WorkspaceResponseDTO>;
    update: (id: string, dto: UpdateWorkspaceDTO) => ApiResult<WorkspaceResponseDTO>;
...
export type CheckUpdateFn = () => DwResultAsync<UpdateServerResponse | undefined>;
...
export interface DesktopEmbedAPI {
    createFromLocalFile: (filePath: string, workspaceId: string) => ApiResult<EmbedResponseDTO>;
    createFromArrayBuffer: (buffer: ArrayBuffer, filetype: string, workspaceId: string) => ApiResult<EmbedResponseDTO>;
    getById: (id: string) => ApiResult<EmbedResponseDTO>;
    getEncoded: (ids: string[]) => ApiResult<Record<string, string>>;
