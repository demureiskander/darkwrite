...
<Aside type="note">
The macOS build is currently unsigned and not notarized. If macOS prevents its
first launch, open **System Settings → Privacy & Security** and select
**Open Anyway** for Darkwrite. Do not run terminal commands that disable
macOS security checks globally.
