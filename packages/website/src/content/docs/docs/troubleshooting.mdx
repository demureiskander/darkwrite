...
- Go to our [releases page](https://github.com/demureiskander/darkwrite/releases), and download the release you previously had installed. Run the installer to downgrade the app.
