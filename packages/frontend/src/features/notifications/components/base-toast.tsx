...
export function ToastClose() {
  ...
  return (
    <button
      ...
      className="-m-1 grid size-6 place-items-center rounded-full bg-transparent text-muted-foreground transition-[transform,color,background-color] duration-100 hover:bg-secondary hover:text-foreground active:scale-75 active:bg-secondary/80"
    >
      <X size={16} />
    </button>
  );
