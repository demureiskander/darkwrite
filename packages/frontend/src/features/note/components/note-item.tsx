...
import { DropPosition } from "@/features/dnd/proximity-dnd";
...
import { useNoteItemDnD } from "../hooks/use-note-item-drag";
    ...
    <NoteContextMenuContainer noteId={item.id}>
      ...
      >
        ...
        <TextTooltip text={t("sidebar.notes.contextmenu.newSubpage")}>
          <button
            onClick={() => {
              dispatch(createNote({ parentId: item.id, renameAfter: true }));
