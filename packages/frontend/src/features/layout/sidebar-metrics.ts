...
const GAP = 4; // gap-1
const PADDING = 8; // p-2
const BUTTON_COUNT = 1; // only collapse remains visible at compact widths

export const BASE_MIN_WIDTH = 120;
export const BASE_MAX_WIDTH = 320;
 ...
 * sidebar. The app menu and search hide at compact widths. */
